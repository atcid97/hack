...
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" ATC COMPANY"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" ATC_ID"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ RISKI"$i"  |"
echo $i" |"$cy"                            "$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 08XXXXXXXX"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" XXXXXXXX@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"ATC_ID"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 08XXXXXXXX"
echo $ku"Facebook :"$i" XXXXXXXX"
sleep 2
